//! gRPC client for communicating with the Hatch coordinator.

use anyhow::{Context, Result};
use hatch_common::{config::AgentConfig, MacChipInfo};
use hatch_crypto::HatchKeypair;
use hatch_proto::agent::agent_service_client::AgentServiceClient;
...
impl CoordinatorClient {
    ...
    pub async fn register(
        ...
        let capabilities = ProviderCapabilities {
            ...
            floor_price_htc_per_hour: cfg.floor_price_htc_per_hour,
