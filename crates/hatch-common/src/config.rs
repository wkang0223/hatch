...
/// Agent configuration (stored at ~/.config/hatch/agent.toml)
...
pub struct AgentConfig {
    ...
    pub floor_price_htc_per_hour: f64,        // Default: 0.05
    ...
    fn default() -> Self {
        Self {
            ...
            coordinator_endpoints: vec![
                "https://coord1.hatch.io:8080".into(),
                "https://coord2.hatch.io:8080".into(),
                "https://coord3.hatch.io:8080".into(),
            ],
...
fn detect_region() -> String {
    ...
    std::env::var("HATCH_REGION").unwrap_or_else(|_| "us-east-1".into())
}
