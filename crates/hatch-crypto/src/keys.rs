//! Ed25519 keypair management for Hatch nodes.
...
/// A Hatch Ed25519 keypair (signing + verifying).
pub struct HatchKeypair {
    inner: SigningKey,
}
...
/// A Hatch public key used to verify signatures.
#[derive(Debug, Clone)]
pub struct HatchPublicKey {
    inner: VerifyingKey,
}
