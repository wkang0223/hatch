...
use crate::keys::{HatchKeypair, HatchPublicKey};
use anyhow::Result;
use hatch_common::MacChipInfo;
...
impl Attestation {
    ...
    pub fn create(keypair: &HatchKeypair, job_id: &str, chip: MacChipInfo) -> Self {
    ...
    pub fn verify(&self) -> Result<()> {
        let pubkey = HatchPublicKey::from_hex(&self.claim.provider_pubkey)?;
