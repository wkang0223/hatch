...
const DEFAULT_COORDINATOR: &str = "https://hatch-coordinator-production-666f.up.railway.app";
const DEFAULT_LEDGER: &str      = "https://hatch-ledger-production-9e83.up.railway.app";
...
impl CliConfig {
    pub fn load(coordinator_override: Option<&str>, ledger_override: Option<&str>) -> Result<Self> {
        ...
        if let Ok(id) = std::env::var("HATCH_ACCOUNT_ID") { cfg.account_id = Some(id); }
